...
- **Match Analyzer** — compare two teams' formations head-to-head on a pitch
  ...
  season records
- **Deeper Context report** (in the Analyzer) — motivation/stakes and injuries
  from live data, plus an optional AI layer (human intelligence, sentiment, and
  a 1–10 **Trap Score**) generated by Claude. This is educational context only —
  never a bet or a prediction — with a responsible-gambling disclaimer
